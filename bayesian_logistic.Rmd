...
# Fit Bayesian Logistic Regression Model with Horseshoe Prior
hs_prior <- hs()
fit_hs <- stan_glm(outcome ~ ., data = train_data, family = binomial(link = "logit"), prior = hs_prior, chains = 2, iter = 1000, seed = 213, cores = 2)
...
k_folds <- 10
cv_varsel <- cv_varsel(fit_hs, method = "forward", K = k_folds, refit_prj = FALSE)
print(cv_varsel)
...
# Fit Bayesian Logistic Regression Model with Horseshoe Prior
hs_prior <- hs()
fit_hs <- stan_glm(outcome ~ ., data = train_data, family = binomial(link = "logit"), prior = hs_prior, chains = 2, iter = 1000, seed = 213, cores = 2, thin = 2)
...
k_folds <- 5
cv_varsel <- cv_varsel(fit_hs, method = "forward", K = k_folds, refit_prj = FALSE, ncores = 2)
print(cv_varsel)
