...
# Initial parameters for xgboost with conservative settings
params <- list(
  objective = "binary:logistic",
  eval_metric = "auc",
  eta = 0.1,             # Learning rate
  max_depth = 2,         # Shallow trees
  min_child_weight = 5,  # Conservative min_child_weight
  subsample = 0.8,       # Subsample ratio
  colsample_bytree = 0.8, # Feature subsample ratio
  lambda = 1,            # Mild L2 regularization
  alpha = 1,             # Mild L1 regularization
...
# Check CV error rate
cv_error <- cv$evaluation_log
train_error <- as.numeric(cv_error[best_nrounds, "train_auc_mean"])
test_error <- as.numeric(cv_error[best_nrounds, "test_auc_mean"])
cat("Train AUC:", train_error, "\n")
cat("Test AUC:", test_error, "\n")
...
# Adjust the decision threshold to improve true negatives (optional threshold tuning)
optimal_threshold <- 0.5  # You can automate this using ROC analysis or Youden's J statistic
...
# Initial parameters for a very basic xgboost model
params <- list(
  objective = "binary:logistic",
  eval_metric = "auc",
  eta = 0.1,             # Learning rate
  ...
  colsample_bytree = 1   # No feature subsampling
)
...
# Plot feature importance
xgb.plot.importance(importance_matrix, main = "Feature Importance (Baseline Model)")
