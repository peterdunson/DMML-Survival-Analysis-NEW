...
params <- list(
  objective = "binary:logistic",
  eval_metric = "auc",
  max_depth = 3,          # Increase tree depth slightly to capture more patterns
  eta = 0.1,             # Decrease learning rate for finer updates
  subsample = 0.5,        # Increase subsample ratio
  colsample_bytree = 0.5, # Increase column subsample ratio
  lambda = 1,             # Increase L2 regularization
  alpha = 0,              # Increase L1 regularization
  nthread = 2
)
